...
export class GitHubLayerService {
    private _userName: string = 'vitalikryzhenkous';
    private _clientID:string = 'Iv1.aee58b33fc9ae7ab';
    private _clientSecret: string = '5e9363cf49061ebaabff1e2083ab2e38a16a692e';
